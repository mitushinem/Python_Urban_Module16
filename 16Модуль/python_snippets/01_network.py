...
headers = {'urban-univercity': '16 module'}
...
response_with_redirect = requests.get('https://gitlab.urban-univercity.ru/learning_materials/python_base')
...
response_without_redirect = requests.get('https://gitlab.urban-univercity.ru/learning_materials/python_base', allow_redirects=False)
...
try:
    response_with_timeout = requests.get('https://gitlab.urban-univercity.ru/', timeout=0.01)
except requests.exceptions.ReadTimeout:
    print("HTTPSConnectionPool(host='gitlab.urban-univercity.ru', port=443): Read timed out. (read timeout=0.01)")
