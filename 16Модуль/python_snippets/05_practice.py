...
# Шаг 1 - выкачиваем картинки с https://course.urban-univercity.ru/profession-python

html = requests.get('https://course.urban-univercity.ru/profession-python').text
